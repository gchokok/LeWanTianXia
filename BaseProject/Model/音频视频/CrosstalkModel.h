...
@class CrosstalkTracksModel, CrosstalkAlbumModel;

@interface CrosstalkModel : BaseModel

@property(nonatomic,strong) CrosstalkAlbumModel *album;
@property(nonatomic,strong) NSNumber *msg;
@property(nonatomic,strong) NSNumber *ret;
@property(nonatomic,strong) CrosstalkTracksModel *tracks;
@end


@interface CrosstalkAlbumModel : BaseModel
...
@interface CrosstalkTracksModel : BaseModel
...
@interface CrosstalkTracksListModel : BaseModel
